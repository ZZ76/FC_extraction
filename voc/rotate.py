...
#src_path, dst_path = './DFC_300', './tmp'
#src_path, dst_path = './DFC_bw_300', './tmp'
#src_path, dst_path = './GFC_300', './tmp'
src_path, dst_path = './GFC_bw_300', './tmp'
...
def rotate_save(name):
    ...
    for n in range(2, 5, 1):
        ...
        new_img = img[1:sample_size, 1:sample_size]   # get rid of black border after affine transformation
